...
class Panel(ScreenPanel):
    ...
    def _initialize_ui(self):
        ...
        self.top_hbox.pack_start(self._create_left_panel(), False, False, 0)
        ...
        self.main_box.pack_start(self.top_hbox, False, False, 0)
    ...
    def _create_icon_title_box(self, icon_name, title_text):
        icon = self._gtk.Image(icon_name, *self._scaled(0.04, 0.05))
    ...
    def _create_right_default_panel(self):
        ...
        bottom_buttons_hbox.set_margin_top(30)
    ...
    def _create_right_progress_panel(self):
        ...
        right_progress_panel.pack_start(Gtk.Box(vexpand=True), True, True, 0)
